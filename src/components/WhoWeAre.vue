...
<template>
    <section class="px-10 flex gap-8">
            <div class="w-[60%] p-8">
                ...
                <p class="mb-4 p-4 border-4 border-transparent border-l-black">Lorem ipsum dolor sit amet, consectetur
                    adipiscing elit. Sed
                    quam tortor, ultrices accumsan mauris eget, pulvinar tincidunt erat. Sed nisi nisi, rutrum sit amet
                    elit</p>
                <ul>
            ...
            <div class="p-8 w-[40%]">
                <div class="bg-slate-400 w-full flex flex-col gap-5 p-6 rounded-xl">
                    ...
                    <h3 class="text-4xl font-bold">Basic Plan</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    <strong class="text-cyan-600 font-black text-6xl">$ 490/ mo</strong>
                    <ul>
                        <li class="flex justify-between">Fractional Load
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-10 text-cyan-600">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                        </li>
                        <li class="flex justify-between">Refrigerated Cargo
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-10 text-cyan-600">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        ...
                        <li class="flex justify-between">Regional Delivery
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-10 text-cyan-600">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        ...
                        <li class="flex justify-between">Hazardous Cargo
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-10 text-cyan-600">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li class="flex justify-between">Mobile Tracking
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-10 text-cyan-600">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
